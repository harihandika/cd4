            ...
            <div class="card">
              ...
              <div class="col-lg-12">
                ...
                <div class="col-lg-1" style="display:inline-block;text-align:right;width:100%;">
                  <button onclick="showgroupsk()" class="btn btn-secondary">Tampilkan Soal</button>
                </div>
              </div>
              </div>
              <!-- /.card-header -->
...
<script>
  ...
  function showgroupsk() {
    $.ajax({
          url: "<?= base_url('soal/showgroupsk') ?>",
          type: "post",
          beforeSend: function() {
  ...
  function editsoal(soal_id) {
    $.ajax({
        url: "<?= base_url('soal/editsoallatihan') ?>",
        type: "post",
        dataType: "json",
        data: {
          "soal_id": soal_id
