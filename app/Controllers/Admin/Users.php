    ...
    public function hasilpdf() {
        ...
        $materi = $this->request->getUri()->getSegment(5);
            ...
            $ret = "<div>
                        ...
                        <div>
                        <table style=\"table-layout:fixed;color:#000000;\">
                        <tbody>
                        <tr style=\"font-size:15px;border-bottom:1px solid black;\"><td width=\"150\">Passhand</td><td width=\"20\" colspan=\"2\" style=\"text-align:center;\">:</td></tr>
                        <tr style=\"font-size:10px;border-bottom:1px solid black;\"><td colspan=\"3\"><div>
                        ...
                        <tr style=\"font-size:15px;border-bottom:1px solid black;height: 50px;\"><td>Kecerdasan</td><td width=\"20\" style=\"text-align:center;\">:</td><td width=\"50\" style=\"text-align:center;\"><label>$persen_kec</label></td></tr>
                        <tr style=\"font-size:15px;border-bottom:1px solid black;height: 50px;\"><td>Kepribadian</td><td style=\"text-align:center;\">:</td><td style=\"text-align:center;\"><label>$persen_kep</label></td></tr>
                        <tr style=\"font-size:15px;border-bottom:1px solid black;height: 50px;\"><td>Sikap Kerja</td><td style=\"text-align:center;\">:</td><td style=\"text-align:center;\"><label>$persen_sk</label></td></tr>
                        </tbody>
                        </table>
                        </div>";
            $ret .= $skskor;
