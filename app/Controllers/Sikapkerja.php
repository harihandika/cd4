...
class Sikapkerja extends BaseController
{
    ...
    public function startujian() {
        ...
        if ($class_soal == "finish") {
            ...
            $ret = "<div class='col-lg-12' style='color:#000000;'>
                    <div style='width:100%;text-align:center;'>
                    <h1 style='margin:10px;float:left;'>Soal $no_soal </h1>
                    </div>
                    <div class='row'>
                    <div class='col-lg-12'>
                        <div style='text-align:center;'>
                    ...
                    $ret .= "</tr>
                        ...
                        <div class='col-md-5' style='text-align:center;margin-top:30px;'>
                        <table style='width: 100%;margin: 0 auto;border-spacing:15px;border-collapse: separate;'>
                        <tbody>
                ...
                foreach ($getjawaban as $k) {
                    ...
                    $ret .= "<td style='border:1px solid black;padding:10px 10px;'><label style='cursor:pointer;width:100%;height:100%;' onclick='startujiansk(\"nextsoal\",$no_soal,$kolom_id,$used,$jawaban_id,\"A\")'>A</label></td>
                            <td style='border:1px solid black;padding:10px 10px;'><label style='cursor:pointer;width:100%;height:100%;' onclick='startujiansk(\"nextsoal\",$no_soal,$kolom_id,$used,$jawaban_id,\"B\")'>B</label></td>
                            <td style='border:1px solid black;padding:10px 10px;'><label style='cursor:pointer;width:100%;height:100%;' onclick='startujiansk(\"nextsoal\",$no_soal,$kolom_id,$used,$jawaban_id,\"C\")'>C</label></td>
                            <td style='border:1px solid black;padding:10px 10px;'><label style='cursor:pointer;width:100%;height:100%;' onclick='startujiansk(\"nextsoal\",$no_soal,$kolom_id,$used,$jawaban_id,\"D\")'>D</label></td>
                            <td style='border:1px solid black;padding:10px 10px;'><label style='cursor:pointer;width:100%;height:100%;' onclick='startujiansk(\"nextsoal\",$no_soal,$kolom_id,$used,$jawaban_id,\"E\")'>E</label></td>";
                }
